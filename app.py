...
# sidebar
with st.sidebar:
    st.markdown("# Digital health")
    st.write("Swimming in the vast sea of online lectures")
    st.markdown("## About")
    st.markdown("**Digital health** aids in the continuous exploration of specialized concept(a.k.a knowledge) that is yet unfamiliar, derived from a vast amount of online lectures.")
